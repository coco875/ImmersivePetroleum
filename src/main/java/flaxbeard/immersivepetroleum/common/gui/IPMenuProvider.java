...
public interface IPMenuProvider<T extends BlockEntity & IPMenuProvider<T>> extends IEBlockInterfaces.IInteractionObjectIE<T>{
	...
	record BEContainerIP<T extends BlockEntity, C extends IEBaseContainerOld<? super T>> (RegistryObject<MenuType<C>> type, IEMenuTypes.BEContainerConstructor<T, C> factory){
